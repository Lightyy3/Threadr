...
const SignUpPage = () => {
  return (
    <div
      ...
      style={{
        backgroundImage: "url('/assets/icons/background-image.jpg')", // Replace with your image path
    ...
    >
      ...
      <div className="w-full lg:w-1/2 flex flex-col gap-4">
        <h1 className="text-2xl xsm:text-4xl md:text-6xl font-bold text-white">
          Stay in the Loop
        </h1>
        <h1 className="text-2xl text-white">Get started today.</h1>
        <SignUp.Root>
